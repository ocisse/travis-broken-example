# This Makefile is for the Fgmp extension to perl.
#
...
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[Fgmp]
#     PREREQ_PM => { Text::Tabs=>q[98.112801], IPC::Open3=>q[1.13], Test::More=>q[0.45], Filter::Simple=>q[0.78] }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[lib/Fgmp_test.pm]
...
EXE_EXT = 
FULL_AR = /usr/bin/ar
LD = cc -mmacosx-version-min=10.11.3
...
MAKEMAKER   = /Users/ousmanecis/perl5/lib/perl5/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.98
MM_REVISION = 69800
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'generated_by: '\''ExtUtils::MakeMaker version 6.98, CPAN::Meta::Converter version 2.133380'\''' >> META_new.yml
	$(NOECHO) $(ECHO) 'license: unknown' >> META_new.yml
	$(NOECHO) $(ECHO) 'meta-spec:' >> META_new.yml
	$(NOECHO) $(ECHO) '  url: http://module-build.sourceforge.net/META-spec-v1.4.html' >> META_new.yml
	$(NOECHO) $(ECHO) '  version: 1.4' >> META_new.yml
	$(NOECHO) $(ECHO) 'name: Fgmp' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Filter::Simple: 0.78' >> META_new.yml
	$(NOECHO) $(ECHO) '  IPC::Open3: 1.13' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::More: 0.45' >> META_new.yml
	$(NOECHO) $(ECHO) '  Text::Tabs: 98.112801' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "generated_by" : "ExtUtils::MakeMaker version 6.98, CPAN::Meta::Converter version 2.133380",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "Fgmp",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Filter::Simple" : "0.78",' >> META_new.json
	$(NOECHO) $(ECHO) '            "IPC::Open3" : "1.13",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Test::More" : "0.45",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Text::Tabs" : "98.112801"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Filter::Simple" VERSION="0.78" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="IPC::Open3" VERSION="1.13" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Test::More" VERSION="0.45" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE VERSION="98.112801" NAME="Text::Tabs" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/Fgmp_test.pm blib/lib/Fgmp_test.pm 
